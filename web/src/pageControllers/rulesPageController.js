...
import { loadRules, saveRules, summarizeRule } from "../../scripts/rules-engine.js";

export function initRulesPage() {
  if (window.__walletlensRulesPageInitialized) return;
  window.__walletlensRulesPageInitialized = true;
